...
import { generateAthletePDF, generatePaymentReportPDF, generateDashboardSummaryPDF } from '../../utils/pdfExport';
        ...
        switch (templateId) {
          case 'athlete-profile':
            await generateAthletePDF(
              { name: 'Carlos Rodríguez', email: 'carlos@email.com', phone: '+34 612 345 678', joinDate: '15/03/2024', membershipType: 'premium' },
