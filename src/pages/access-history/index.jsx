  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-[#F8FAFC] py-6 md:py-8 pb-24">
        ...
        <div className="bg-white rounded-[2rem] border border-slate-100 shadow-sm p-6 md:p-7 mb-7 flex flex-col xl:flex-row xl:items-center xl:justify-between gap-4">
          <div>
            <BreadcrumbTrail
              items={[
          ...
          <div className="flex flex-wrap items-center gap-2 bg-slate-50 border border-slate-200 p-1.5 rounded-2xl w-full xl:w-auto">
          ...
          <div className="xl:col-span-4 space-y-4">
            ...
            <div className="bg-white rounded-[2rem] border border-slate-100 shadow-sm p-3 max-h-[700px] overflow-y-auto custom-scrollbar">
              {loading && groupedLogs.length === 0 ? (
                [1,2,3,4,5].map(i => (
                  <div key={i} className="h-20 bg-slate-50 rounded-2xl mb-2 animate-pulse" />
                ))
