...
const MetricCard = ({ title, value, unit, change, changeType, icon, iconColor }) => {
  ...
  // const isNeutral = changeType === 'neutral'; // No se usa explícitamente pero está implícito

  return (
    <div className="bg-card border border-border rounded-lg p-4 md:p-5 lg:p-6 transition-smooth hover:shadow-glow-primary h-full">
      <div className="flex items-start justify-between mb-3 md:mb-4">
        ...
        <div 
          ...
          style={{ backgroundColor: iconColor?.startsWith('#') || iconColor?.startsWith('var') ? `${iconColor}20` : undefined }} 
          // Ajuste: si iconColor es una clase de tailwind no aplicamos estilo inline, si es hex/var sí.
          // En tu index.jsx usas variables CSS (var(--color...)), así que el estilo inline funciona perfecto.
        >
